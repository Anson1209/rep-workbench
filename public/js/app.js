...
(function () {
  ...
  console.log('%c[rep-workbench] build e5f8b2d · 2026-09-10 16:20 · 字号回调：姓名13/胶囊10/科室10+卡片padding5/7，更清爽', 'background:#0a7;color:#fff;padding:2px 6px;border-radius:4px');
