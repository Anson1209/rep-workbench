...
(function () {
  ...
  console.log('%c[rep-workbench] build 2a8f1c4 · 2026-09-07 13:19 · 问卷台账同一客户聚合为一行(调研日期/备注分行列出+次数合计+额度合计+明细展开)', 'background:#0a7;color:#fff;padding:2px 6px;border-radius:4px');
