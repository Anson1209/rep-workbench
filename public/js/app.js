...
(function () {
  ...
  console.log('%c[rep-workbench] build 9c1e7b3 · 2026-09-07 13:07 · 问卷台账：2026年6月前的调研豁免30天间隔约束(6月起照常校验)', 'background:#0a7;color:#fff;padding:2px 6px;border-radius:4px');
