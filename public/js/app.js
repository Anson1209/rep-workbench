...
(function () {
  ...
  console.log('%c[rep-workbench] build h3k8m2p · 2026-09-10 22:20 · 问卷台账usageDate改为可选(支持后续补录日期)；回退客户资料surveyScope误加字段，9人调研改入问卷台账', 'background:#0a7;color:#fff;padding:2px 6px;border-radius:4px');
  ...
  const ICON = {
    ...
    clinic: '<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M3 9h18M8 3v4M16 3v4"/><path d="M12 12v4M10 14h4" stroke-width="2.2"/></svg>',
